...
#
# C++ renders into a private offscreen FBO — completely separate from SDL.
...
class ThreeDeeEngine:
    ...
    SDL does the final flip — no fighting, no flicker.
    """
    ...
    def __init__(self, screen: pygame.Surface):
        ...
        print(f"[ThreeDee] offscreen renderer ready ({self.width}×{self.height})")
