    ...
    def load_enemies(self):
        ...
        for enemy_data in level_enemies:
            ...
            # -------------------------
                ...
                try:
                    if enemy_type == "shadowrock":
                        from sprites.shadowrock.shadowrock import ShadowRock
                        enemy = ShadowRock()
                    elif enemy_type == "blobtigoo":
                        from sprites.blobtigoo.blobtigoo import blobtigoo
                        enemy = blobtigoo() 
                    elif enemy_type == "ohgodwhathaveyoudone":
                        from sprites.ohgodwhathaveyoudone.ohgodwhathaveyoudone import Ohboy
                        enemy = Ohboy()
                    elif enemy_type == "save":
                        enemy = SaveOBJ()
                    elif enemy_type == "mrtutor":
                        from sprites.mrtutor.mrtutor import MrTutor
                        enemy = MrTutor()
                    elif enemy_type == "wdcibles":
                        from sprites.wdcibles.wdcibles import wdcibles
                        enemy = wdcibles()
                    elif enemy_type == "lantern":
                        from sprites.lantern.lantern import lantern
                        enemy = lantern(self)
