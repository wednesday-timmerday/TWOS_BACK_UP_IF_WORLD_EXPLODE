...
DEVICE = 23  # ðŸŽ¯ CABLE Output (VB-Audio Virtual Cable)
            ...
            if sample_index - last_peak_sample > min_gap_samples:
                ...
                # ===== LIVE TRACK =====
                    ...
                    if abs(t - predicted) < tolerance:
                        print(f"ðŸ¥ Beat {beat_index} âœ…")
                    else:
                        print(f"âš ï¸ Off-beat ({t - predicted:.3f}s)")
...
# START
# =====================
print("ðŸŽ§ Luisteren naar systeem-audio via VB-Cable...")
print("ðŸ‘‰ Zorg dat je app geluid naar VB-Cable stuurt!")
