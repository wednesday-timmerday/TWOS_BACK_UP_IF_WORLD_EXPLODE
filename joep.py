...
# Formant tables  (F1, F2, F3, F4)  all in Hz  â€” Peterson & Barney + Hillenbrand
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _g2p_rules(word: str) -> List[str]:
    ...
    while i < n:
        ...
        if i+3 < n:
            quad = w[i:i+4]
            if quad == "tion":   # nation, station â†’ sh+ah+n
                phones.extend(["sh","ah","n"]); i+=4; continue
            if quad == "sion":   # vision, passion â†’ zh+ah+n
                phones.extend(["zh","ah","n"]); i+=4; continue
        # 3-char sequences
        if i+2 < n:
            tri = w[i:i+3]
            if tri == "ion":     # ion, ions â†’ ay+ah+n
        ...
        if c in "aeiou":
            ...
            if c == 'a':
                ...
                # "io" â†’ iy + ow as two separate sounds (radio, audio, ratio, ion)
...
# Contraction expansions â†’ phoneme sequences directly
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# LF (Liljencrants-Fant) glottal pulse  â€” much more realistic than sine harmonics
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def parallel_formant_synth(src: np.ndarray,
    ...
    """Sum parallel resonators â€” avoids spectral smearing of cascade filters"""
    if gains_db is None:
...
def f0_contour(n: int, stressed: bool, phrase_pos: float) -> np.ndarray:
    """
    phrase_pos: 0=start â€¦ 1=end of utterance  (for declination)
    """
...
def synth_vowel(ph: str, n: int, f0: np.ndarray,
    ...
    # Parallel formant bank â€” use time-varying formants by splitting into frames
    FRAME = 64
    out = np.zeros(n, dtype=np.float32)
...
def synth_nasal(ph: str, n: int, f0: np.ndarray) -> np.ndarray:
    ...
    # Nasal resonances â€” low F1 + anti-formants â†’ use cascade LP here
    if ph == "m":
        out = lpf(src, 350, 4)
    elif ph == "n":
...
def synthesize_text(text: str, speed: float = 1.0) -> np.ndarray:
    ...
    # â”€â”€ Post-processing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
