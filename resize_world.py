...
class Element:
    ...
    def __init__(self, x=50, y=50):
        self.x = x      # pixels (canvas-coördinaten)
        self.y = y
        self.selected = False
...
class CardCanvas(tk.Canvas):
    """Interactief canvas voor één kaart-zijde."""
...
class TextEditDialog(tk.Toplevel):
    ...
    def _build(self):
        ...
        tk.Button(cf, text="Kies kleur…", command=self._pick_color,
...
class PropertiesPanel(tk.Frame):
    """Rechter paneel — toont eigenschappen van het geselecteerde element."""
    ...
    def show(self, el, canvas: CardCanvas):
        ...
        if isinstance(el, ImageElement):
            ...
            tk.Button(self, text="Vervang afbeelding…",
        ...
        if isinstance(el, TextElement):
            tk.Frame(self, bg="#333", height=1).pack(fill="x", padx=10, pady=4)
            tk.Button(self, text="Tekst bewerken…",
        ...
        tk.Button(self, text="🗑 Verwijderen",
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Kaart Ontwerper  •  A6 dubbelzijdig")
    ...
    def _build_ui(self):
        ...
        tk.Label(toolbar, text="  ✦ Kaart Ontwerper",
                 bg="#1a1a1a", fg="#e8c97a",
        ...
        tb_btn("💾 Opslaan",     self._save,       "#555"  ).pack(side="left", padx=3)
        tb_btn("📂 Openen",      self._open,       "#555"  ).pack(side="left", padx=3)

        tk.Frame(toolbar, bg="#444", width=1, height=28).pack(side="left", padx=8)

        tb_btn("📄 Exporteer PDF", self._export_pdf, "#8b2020").pack(side="left", padx=3)

        # ── Tab-switcher ───────────────────────────────────────────────────────
        tab_bar = tk.Frame(self, bg="#141414", pady=6)
        tab_bar.pack(fill="x")

        self.tab_front = tk.Button(tab_bar, text="▣  Voorkant",
        ...
        self.tab_back  = tk.Button(tab_bar, text="▣  Achterkant",
        ...
        tk.Label(tab_bar, text="A6  148,5 × 105 mm",
        ...
        tk.Label(canvas_outer, text="↕ sleep elementen  |  dubbelklik = tekst bewerken  |  Del = verwijderen",
    ...
    def _export_pdf(self):
        ...
        try:
            ...
            messagebox.showinfo(
                ...
                f"✅  PDF opgeslagen:\n{path}\n\n"
                "Pagina 1 = voorkant\nPagina 2 = achterkant\n\n"
                "Druk in op: Dubbelzijdig  →  Omslaan langs korte zijde\n"
